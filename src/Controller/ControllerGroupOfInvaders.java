...
public class ControllerGroupOfInvaders {
    ...
    private groupOfInvaders groupInvader;
    ...
    public ControllerGroupOfInvaders() {
        this.groupInvader = new groupOfInvaders();
    }
    /**
    ...
    public ControllerGroupOfInvaders(int xInicial, int yInicial, int row, int column, int speed, int refreshRateInvaders) {
        this.groupInvader = new groupOfInvaders(xInicial, yInicial, row, column, speed, refreshRateInvaders);
    }
    //------------------Methods------------------------------------------  
 ...
 */
     ...
     */
    public groupOfInvaders getGroupInvader() {
        return groupInvader;
    }
    /**
     ...
     */
    public void setGroupInvader(groupOfInvaders groupInvader) {
     ...
     */
    public Invader getInvader(int invader) {
