...
public class Game extends javax.swing.JPanel implements Runnable {
    ...
    private GameBar consumiblesTanque; //barrera encargada de mostrar los consumibles
...
//____________________________________________________________________
 ...
 //-----------------Constructor---------------------------------------- 
    ...
    public void visible(){
        ...
        visual[4] = true;//mostrar las barreras de defensa 
    }
...
//------------------GetSetters----------------------------------------
     ...
     */
    public void setConsumiblesTanque(GameBar consumiblesTanque) {
